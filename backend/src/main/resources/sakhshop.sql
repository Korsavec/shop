...
--
-- Хост: localhost
-- Время создания: Окт 22 2022 г., 12:58
...
ALTER TABLE `model_seller_individual`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UK23gc0stplfdmp2rxs41ou8o6v` (`password`),
  ...
  ADD UNIQUE KEY `UKeqlf3kvlejv39jn77amexmfn0` (`email`),
...
ALTER TABLE `model_seller_limited`
  ...
  ADD UNIQUE KEY `UK1arj6sflsccpb9b2qblf8fedj` (`password`),
  ...
  ADD UNIQUE KEY `UK2yf6t1icnpt7beu231jrmyv0w` (`email`),
...
ALTER TABLE `model_seller_person`
  ...
  ADD UNIQUE KEY `UK1ow0k20qoswbakkta8u90p8s4` (`password`),
  ADD UNIQUE KEY `UK_mphqa2bqusjjltmhh75qo7hw9` (`email`),
  ADD UNIQUE KEY `UK_8x6x01a20a4lhlrbrmqs8vrxx` (`inn`),
  ADD UNIQUE KEY `UK_mqam9nh267g3ihim3aej5q7kr` (`inn_bank`),
  ADD UNIQUE KEY `UK_8avvygc8eimb8tpwqj2vx04r5` (`kpp_bank`),
  ...
  ADD UNIQUE KEY `UKmphqa2bqusjjltmhh75qo7hw9` (`email`),
...
ALTER TABLE `model_users`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UKc0imvd5q48cu2njq07mwe70b9` (`password`),
  ADD UNIQUE KEY `UK_7p8cjud14cxguvri01wu774t8` (`email`),
  ADD UNIQUE KEY `UK7p8cjud14cxguvri01wu774t8` (`email`),
